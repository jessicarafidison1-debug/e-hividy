...
// connection mixins
// implementation of http://dev.mysql.com/doc/internals/fr-FR/compression.html
...
function writeCompressed(buffer) {
  // http://dev.mysql.com/doc/internals/fr-FR/example-several-mysql-packets.html
    ...
    connection.deflateQueue.push((task) => {
      zlib.deflate(buffer, (err, compressed) => {
        ...
        if (compressedLength < packetLen) {
          ...
          // http://dev.mysql.com/doc/internals/fr-FR/uncompressed-payload.html
