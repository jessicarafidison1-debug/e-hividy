...
// https://dev.mysql.com/doc/internals/fr-FR/packet-OK_Packet.html
  ...
  constructor(packet, connection) {
    ...
    if (isSet('SESSION_TRACK') && packet.offset < packet.end) {
      ...
      if (this.serverStatus && ServerSatusFlags.SERVER_SESSION_STATE_CHANGED) {
        ...
        // https://dev.mysql.com/doc/internals/fr-FR/packet-OK_Packet.html#cs-sect-packet-ok-sessioninfo
        let len =
